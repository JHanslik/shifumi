...
const logIa3Function = () => {
    if (signIA3 === 0) {
        logIA3 = "AI3 played : Paper"
    }
    else if (signIA3 === 1) {
        logIA3 = "AI3 played : Rock"
    }
    else if (signIA3 === 2) {
        logIA3 = "AI3 played : Scissor"
    }
}
const logIa4Function = () => {
    if (signIA4 === 0) {
        logIA4 = "AI4 played : Paper"
    }
    else if (signIA4 === 1) {
        logIA4 = "AI4 played : Rock"
    }
    else if (signIA4 === 2) {
        logIA4 = "AI4 played : Scissor"
    }
}
